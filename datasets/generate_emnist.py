...
def generate_emnist(dir_path, num_clients, num_classes, niid, balance, partition):
    ...
    trainset = torchvision.datasets.EMNIST(
        root=dir_path+"rawdata", train=True, download=True, split='byclass', transform=transform)
    testset = torchvision.datasets.EMNIST(
        root=dir_path+"rawdata", train=False, download=True, split='byclass', transform=transform)
